  ...
  return (
    <div className="w-full">
      ...
      <section className="relative h-screen min-h-[600px] flex items-center justify-center bg-primary text-white overflow-hidden">
        {/* Background Pattern - subtle noise/gradient */}
        ...
        <div className="container-wide relative z-10 grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl font-serif font-bold leading-tight">
              Protection when <br />
              <span className="text-white/50 italic font-serif">freedom</span> is at stake.
            </h1>
            <p className="text-lg text-white/70 max-w-md leading-relaxed">
              Strict adherence to the law. Uncompromising defense of your interests. 
              We provide high-level legal strategies for complex cases.
            </p>
          ...
          {/* Abstract Hero Visual - Represents Structure/Law */}
          <motion.div 
          ...
          >
             ...
             {/* Use an Unsplash image with overlay for professional look */}
             {/* Office Architecture / Abstract */}
      ...
      <section className="bg-white border-b border-border">
        <div className="container-wide py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 divide-y md:divide-y-0 md:divide-x divide-border">
            {[
              { icon: Scale, label: "Won Cases", value: "500+" },
              { icon: Award, label: "Google Rating", value: "4.9/5" },
              { icon: ShieldCheck, label: "Licensed by", value: "NAAU" },
            ].map((stat, i) => (
        ...
        <div className="container-wide">
          <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
            <div className="max-w-2xl">
              <h2 className="text-4xl font-serif mb-4">Areas of Practice</h2>
              <p className="text-muted-foreground">Comprehensive legal support for individuals and businesses. We specialize in complex litigation and strategic defense.</p>
            </div>
            <Link href="/services">
      ...
      <section className="section-padding bg-white">
        <div className="container-wide">
           <div className="text-center mb-16">
              <span className="text-xs uppercase tracking-[0.2em] text-muted-foreground mb-2 block">Our Experts</span>
              <h2 className="text-4xl font-serif">Meet the Attorneys</h2>
           </div>
      ...
      <section className="py-24 bg-primary text-white relative overflow-hidden">
        ...
        <div className="container-wide relative z-10 text-center space-y-8">
          <h2 className="text-3xl md:text-5xl font-serif">Do you have a legal problem?</h2>
          <p className="text-white/60 max-w-xl mx-auto">
            Don't let the situation escalate. Contact us for a professional assessment of your case and development of a defense strategy.
          </p>
